    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background: url(assets/img/Rabbi.jpg)">
          ...
          <!-- Slide 2 -->
          <div class="carousel-item" style="background: url(assets/img/Cteen.jpg)">
            <div class="carousel-container">
              <div class="carousel-content">
        ...
        <div class="row portfolio-container">
          <div class="col-lg-4 col-md-6 portfolio-item filter-etudiants">
            <div class="portfolio-wrap">
              <img src="assets/img/Téfiline.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Vérification Téfilin & Mézouzot </h4>
                <p>Etudiants</p>
                <div class="portfolio-links">
                  <a href="assets/img/ExplicationTéfiline.jpeg"  class="venobox" title="Vérification Tefilin & Mézouzot"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-fetesjuives">
            <div class="portfolio-wrap">
              <img src="assets/img/Méguila.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Pourim: Lectures de Meguila & Distribution de Michloah Manot</h4>
                <p>Fêtes Juives</p>
                <div class="portfolio-links">
                  <a href="assets/img/ExplicationMéguila.png" class="venobox" title="Voir Plus"><i class="bx bx-plus"></i></a>
                  <a href="Contact.php" title="Nous Contacter"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-fetesjuives">
            <div class="portfolio-wrap">
              <img src="assets/img/Shoffar.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Roch Hachana: Sonnerie Du Shofar à Domicile</h4>
                <p>Fêtes Juives</p>
                <div class="portfolio-links">
                  <a href="assets/img/ExplicationShofar.png" data-gall="portfolioGallery" class="venobox" title="Voir Plus"><i class="bx bx-plus"></i></a>
                  <a href="Contact.php" title="Nous Contacter"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-enfantAdos">
            <div class="portfolio-wrap">
              <img src="assets/img/Cteen.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Cteen</h4>
                <p>Activité</p>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio-4.jpg" data-gall="portfolioGallery" class="venobox" title="Voir Plus"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Web</p>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio-5.jpg" data-gall="portfolioGallery" class="venobox" title="Web 2"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>App</p>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio-6.jpg" data-gall="portfolioGallery" class="venobox" title="App 3"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Card</p>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio-7.jpg" data-gall="portfolioGallery" class="venobox" title="Card 1"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Card</p>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio-8.jpg" data-gall="portfolioGallery" class="venobox" title="Card 3"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Web</p>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio-9.jpg" data-gall="portfolioGallery" class="venobox" title="Web 3"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
