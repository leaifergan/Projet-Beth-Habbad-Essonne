...
<div class="container">
	<div class="row">
    	...
    	<div class="text-center">
 				<br><br><h2> Prochaine activité Cteen de Ris Orangis :</h2>
      ...
      <p></p>
			<p class="text-justify"><i class="icofont-check-circled"></i> L'occasion de faire pleins de nouvelles rencontres</p>
			<p class="text-justify"><i class="icofont-check-circled"></i> Renforcer son judaïsme </p>
			<p class="text-justify"><i class="icofont-check-circled"></i> Des voyages organsiés et Chabbats pleins  </p>
		</div>
	</div>
</div>
